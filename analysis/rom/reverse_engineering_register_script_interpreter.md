...
`FUN_8003aa20`, `invoke_register_script_from_global_context_0x58_0x5c` (`0x800393f8`), `invoke_register_script_dual_from_global_context_pairs` (`0x80039418`, ×2), `invoke_register_script_from_global_context_0x60_0x64` (`0x800393d8`),
`run_bb_reg_init_hook_chain_and_program_0x1e_5bit_field` (`0x800395f0`, ×4), `invoke_register_script_from_global_context_0x38_0x3c` (`0x80039174`), `invoke_register_script_from_literal_pool_with_num_halfwords_0x40` (`0x8003b9a4`), `preserve_bb_regs_5a_5c_run_regscript_hook_then_program_bb_bundle` (`0x8003ab74`),
