...
**Ghidra mis-disassembly artifacts identified, NOT renamed (Pass 32, 2026-06-27)**: `0x8005d548`,
...
as functions by the MIPS16e forced-disassembly pass. `0x80052f18` is a related artifact: a
data global overlapping a "function" address, dereferenced by `lmp_esco_sco_negotiation_packet_handler`
as `*_FUN_80052f18` (a constant, not a call). None of these 6 addresses are real functions —
excluded from future rename targeting, see `region_0x80050000` Pass 32 write-up for detail.
