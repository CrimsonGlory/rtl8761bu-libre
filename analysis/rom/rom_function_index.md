...
| User-named functions in `rom` block (live Ghidra, `SourceType.USER_DEFINED`/`IMPORTED` — ground truth) | **875** as of region 0x80050000 Pass 29 (2026-06-27: 8 newly-renamed — `compute_and_maybe_commit_slot_offset_from_parent`/`advance_esco_state_0x77_to_4_if_config_e4`/`validate_feature_bitmap_and_dispatch_to_0x134`/`set_hw_ctrl_bits_and_update_conn10_0x154`/`toggle_link_register_bit1_for_slot`/`alloc_and_pack_esco_event_record_tag_0x15`/`alloc_and_pack_esco_event_record_tag_0x14`/`alloc_and_copy_event_record_tag_0xe` via `RenamePass29Region80050000.java`, `RENAMED` ×8) on top of the 867 from Pass 28 (6 renames), 861 from Pass 27 (7 renames), 854 from Pass 26 (6 renames), 848 from Pass 25 (4 renames), 844 from Pass 24 (10 renames), which sat on the 770 from PASS 21 (3 renames), 767 from PASS 20 (4 renames), 763 from PASS 15, 761 from PASS 14, 759 from PASS 11-batch-2 + PASS 12, 743 from PASS 10, 737 from the 2026-06-27 rename re-application pass (was 462 at the 2026-06-26 baseline) |
...
| `0x80050000`–`0x8005ffff` | 366 | 109 | 257 | 29.8% |
