...
| User-named functions in `rom` block (live Ghidra, `SourceType.USER_DEFINED`/`IMPORTED` — ground truth) | **898** as of region 0x80050000 Pass 31 (2026-06-27: 14 newly-renamed — `lookup_record_ptr_by_key_via_bsearch`/`lookup_record_by_key_and_promote_to_list_head`/`conn_type_checked_hw_hook_dispatch`/`dispatch_hw_hook_for_main_and_substates`/`alloc_0x54_record_pool_and_ptr_table`/`init_record_pools_and_related_substates`/`alloc_event_record_and_log_tag_0x13`/`alloc_event_record_and_log_tag_0x12`/`alloc_event_record_and_log_tag_0xa`/`alloc_event_record_and_log_tag_0x5`/`check_link_flag_bit6_and_assign_0x134`/`send_lmp25c_and_clear_pending_flag_if_idle`/`program_esco_sco_hw_link_params_and_log`/`negotiate_esco_sco_timing_and_commit_by_mode` via `RenamePass31Region80050000.java`, `RENAMED` ×14) on top of the 884 from Pass 30 (9 renames: `alloc_and_copy_event_record_tag_0x8`/`dequeue_from_per_slot_ring_buffer`/`alloc_and_pack_esco_event_record_tag_0x17`/`alloc_and_pack_esco_event_record_tag_0x16`/`init_0xfc_record_pool_and_send_LMP_25B`/`alloc_and_link_0xfc_record_pool`/`drain_pending_list_and_free_with_hci_evt_pack`/`maybe_commit_afh_quality_poll_to_parent_if_below_threshold`/`validate_connection_field_5bit_and_assign_0x134_on_mismatch` via `RenamePass30Region80050000.java` — `alloc_and_copy_event_record_tag_0x8`/`dequeue_from_per_slot_ring_buffer`/`alloc_and_pack_esco_event_record_tag_0x17`/`alloc_and_pack_esco_event_record_tag_0x16`/`init_0xfc_record_pool_and_send_LMP_25B`/`alloc_and_link_0xfc_record_pool`/`drain_pending_list_and_free_with_hci_evt_pack`/`maybe_commit_afh_quality_poll_to_parent_if_below_threshold`/`validate_connection_field_5bit_and_assign_0x134_on_mismatch` via `RenamePass30Region80050000.java`, `RENAMED` ×9) on top of the 875 from Pass 29 (8 renames), 867 from Pass 28 (6 renames), 861 from Pass 27 (7 renames), 854 from Pass 26 (6 renames), 848 from Pass 25 (4 renames), 844 from Pass 24 (10 renames), which sat on the 770 from PASS 21 (3 renames), 767 from PASS 20 (4 renames), 763 from PASS 15, 761 from PASS 14, 759 from PASS 11-batch-2 + PASS 12, 743 from PASS 10, 737 from the 2026-06-27 rename re-application pass (was 462 at the 2026-06-26 baseline) |
| Unnamed (`FUN_*`) functions in `rom` block (live Ghidra ground truth) | **2234** (2242 prior to this pass's 8 new renames) |
