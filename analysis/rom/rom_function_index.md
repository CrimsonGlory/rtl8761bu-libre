...
| User-named functions in `rom` block (live Ghidra, `SourceType.USER_DEFINED`/`IMPORTED` — ground truth) | **867** as of region 0x80050000 Pass 28 (2026-06-27: 6 newly-renamed — `compute_esco_timing_offset_and_dispatch`/`program_hw_channel_b_and_slot_params_A`/`program_hw_channel_c_and_slot_params_B`/`read_esco_sco_slot_timing_offset_atomic`/`scan_active_slots_and_extract_timing_ranges`/`release_esco_sco_connection_and_clear_state` via `RenamePass28Region80050000.java`, `RENAMED` ×6) on top of the 861 from Pass 27 (7 renames), 854 from Pass 26 (6 renames), 848 from Pass 25 (4 renames), 844 from Pass 24 (10 renames), which sat on the 770 from PASS 21 (3 renames), 767 from PASS 20 (4 renames), 763 from PASS 15, 761 from PASS 14, 759 from PASS 11-batch-2 + PASS 12, 743 from PASS 10, 737 from the 2026-06-27 rename re-application pass (was 462 at the 2026-06-26 baseline) |
...
| `0x80050000`–`0x8005ffff` | 366 | 101 | 265 | 27.6% |
