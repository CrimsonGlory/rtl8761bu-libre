...
| Named-function confidence: **high** (decompiled + written up in a dedicated `rom/*.md`) | 614 (601 + 13 region-0x80010000/0x80030000 low→high upgrade batch, 2026-06-26 — see note below) |
...
| Named-function confidence: **low** (named by Kovah, purpose unclear) | 54 (the 111-remaining figure carried from the prior batch was itself stale — a fresh `grep "low (named by Kovah" rom_function_index.md` at the start of this batch found only **67** real rows project-wide, not 111. This batch resolved 13 of those 67 (7 in region 0x80010000, 6 in region 0x80030000); 54 remain (25 in region 0x80020000, 29 in region 0x80070000). Per this ticket's own instruction ("re-derive the current list... rather than trusting the count above"), treat the table's live grep count as authoritative going forward, not this running tally.) |
