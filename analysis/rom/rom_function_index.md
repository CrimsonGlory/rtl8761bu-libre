...
| `0x80074dfc` | 42 | `called_by_unknown_fptr_indexA_2` | Confirmed: calls a registered predicate fptr; on failure falls back to `FUN_80074dd4`, on success forwards to a second fptr with a 16-bit arg — see `region_0x80070000` (2026-06-26 low→high pass) | high (decompiled+documented, low→high pass 2026-06-26) |
...
| `0x80074e84` | 38 | `called_by_unknown_fptr_indexA_1` | Confirmed: config-flag-gated call to `FUN_8003229c` — see `region_0x80070000` (2026-06-26 low→high pass) | high (decompiled+documented, low→high pass 2026-06-26) |
| `0x80074eb4` | 42 | `unknown_fptr_indexA` | Confirmed: dispatcher routing to `called_by_unknown_fptr_indexA_1` (tag 900) or `_2` (tag 0x385) by a 16-bit field — see `region_0x80070000` (2026-06-26 low→high pass) | high (decompiled+documented, low→high pass 2026-06-26) |
...
| `0x80075650` | 102 | `func4_that_uses_structs_at_0x80100000` | Confirmed: pool-slot "close" op — looks up slot descriptor, calls `FUN_80075b88` to flush, decrements refcount, or logs on failure (func1–func8 resource-pool family) — see `region_0x80070000` (2026-06-26 low→high pass) | high (decompiled+documented, low→high pass 2026-06-26) |
| `0x800756c0` | 62 | `func5_that_uses_structs_at_0x80100000` | Confirmed: pool-slot "reset" op — validates + flushes (`FUN_80075b50`) then zeroes a 6-word descriptor — see `region_0x80070000` (2026-06-26 low→high pass) | high (decompiled+documented, low→high pass 2026-06-26) |
...
| `0x8007572c` | 106 | `func7_that_uses_structs_at_0x80100000` | Confirmed: pool-slot "init/zero-fill" op — computes alignment-rounded size and memsets the slot buffer before calling `FUN_80075c00` — see `region_0x80070000` (2026-06-26 low→high pass) | high (decompiled+documented, low→high pass 2026-06-26) |
...
| `0x800761f4` | 116 | `LMP__25B_meat` | Confirmed: per-index (0–0x3f) state dispatch — status 0x02 triggers extra `FUN_80076090`, non-zero status calls `FUN_800761b4`, zero status logs invalid-state warning — see `region_0x80070000` (2026-06-26 low→high pass) | high (decompiled+documented, low→high pass 2026-06-26) |
...
| `0x80052580` | 52 | `init_record_pools_and_related_substates` (was `FUN_80052580`) | Dispatcher calling `alloc_0x54_record_pool_and_ptr_table()`, `alloc_and_link_0xfc_record_pool()`, plus 5 more sub-inits (`FUN_800518c0`/`FUN_80052458`/`FUN_8005241c`/`FUN_8005220c`/`FUN_80051630`) — top-level "init all record pools" entry point. HIGH: 2 named pool-allocator callees — see `region_0x80050000` Pass 31 2026-06-27 | high (decompiled+documented, Pass 31 2026-06-27) |
