...
| `0x80074940` | 672 | `FUN_80074940` | 5-case dispatch via fn-ptr tables, calls `0x800747b0` for case 2, touches `0x1ac_struct_array`; no opcode literal | medium (decompiled, cold-triage pass 8 2026-06-23) |
...
| `0x800791d0` | 608 | `FUN_800791d0` | Populates a 0x2c-byte struct from a bit-packed page format (5-bit count + bitfields matching LMP feature-page octet layout); logs via `possible_logging_function__var_args(3,0x8e,...)`; structurally close to `LMP_features_validator` but unconfirmed | medium-high (decompiled, cold-triage pass 8 2026-06-23) |
