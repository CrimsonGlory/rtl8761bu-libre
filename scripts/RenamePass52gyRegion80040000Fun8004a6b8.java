// Pass 52gy (region 0x80040000): slot-timing reprogram fan-out for conn 8-10.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gyRegion80040000Fun8004a6b8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004a6b8L, "dispatch_slot_timing_reprogram_conn8_9_10_if_feature_bits_0x801" },
    };
