// Pass 52gt (region 0x80040000): remove entry from sorted index-byte table.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gtRegion80040000Fun8004e154 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e154L, "remove_record_from_sorted_index_table" },
    };
