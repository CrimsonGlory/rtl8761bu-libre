// Pass 52fr (region 0x80040000): >150B rank-1 conn pending-flag param6 commit HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52frRegion80040000Fun8004923c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004923cL, "hci_conn_pending_ee_flag_param6_commit_or_reject_send_cmd_complete" },
    };
