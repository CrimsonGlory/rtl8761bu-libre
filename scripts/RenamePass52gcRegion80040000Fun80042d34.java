// Pass 52gc (region 0x80040000): 1-150B rank-10 inquiry/LAP pending-slot counter.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gcRegion80040000Fun80042d34 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80042d34L, "count_consecutive_inquiry_lap_pending_slot_flags" },
    };
