// Pass 52bs (region 0x80040000): rank-73 substantive from refreshed 1-150B cold-triage
// HCI Command Complete sender with conn10 +0x154 bit2 gate byte and global echo.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52bsRegion80040000Fun80044f9c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80044f9cL, "hci_conn10_0x154_bit2_flag_0x1a_global_byte_send_cmd_complete" },
    };
