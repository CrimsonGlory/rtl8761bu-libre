// Pass 52fp (region 0x80040000): >150B rank-1 LE ext-adv enable bit3 commit HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fpRegion80040000Fun800462b0 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800462b0L, "hci_le_ext_adv_enable_bit3_commit_send_cmd_complete" },
    };
