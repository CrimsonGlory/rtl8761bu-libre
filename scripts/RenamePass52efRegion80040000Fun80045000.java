// Pass 52ef (region 0x80040000): >150B rank-1 conn-type timing finalize rename
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52efRegion80040000Fun80045000 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80045000L, "hci_finalize_conn_type_timing_delta_send_cmd_complete" },
    };
