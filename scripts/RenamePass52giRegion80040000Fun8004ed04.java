// Pass 52gi (region 0x80040000): eSCO link timing conflict checker.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52giRegion80040000Fun8004ed04 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004ed04L, "check_esco_link_timing_conflict_with_active" },
    };
