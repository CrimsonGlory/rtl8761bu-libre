// Pass 52em (region 0x80040000): >150B rank-3 PSM/QoS bitmask commit rename
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52emRegion80040000Fun80049550 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80049550L, "commit_psm_qos_5byte_bitmask_and_send_hci_cmd_complete_and_sync" },
    };
