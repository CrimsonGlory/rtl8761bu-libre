// Pass 52gf (region 0x80040000): conn-type-nibble-2 LMP role-connection setup dispatcher.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gfRegion80040000Fun800411a4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800411a4L, "allocate_conn_record_and_dispatch_lmp_role_connection_setup" },
    };
