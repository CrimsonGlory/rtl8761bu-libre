// Pass 52ga: refresh 1-150B ranks 6-12 for cold-triage continuation
// @category Analysis
...
public class ColdTriageRegion80040000Pass52ga extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 5; i < Math.min(12, allSmall.size()); i++) {
