// Pass 52fa (region 0x80040000): >150B rank-1 LE ext scan-rsp data HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52faRegion80040000Fun8004635c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004635cL, "hci_le_ext_scan_rsp_data_pack_validate_commit_send_cmd_complete" },
    };
