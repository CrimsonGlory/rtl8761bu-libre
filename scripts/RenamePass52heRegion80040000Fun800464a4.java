// Pass 52he (region 0x80040000): HCI read conn TX/RX PHY → Command Complete sender.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52heRegion80040000Fun800464a4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800464a4L, "hci_read_conn_tx_rx_phy_send_cmd_complete" },
    };
