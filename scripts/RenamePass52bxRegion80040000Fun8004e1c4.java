// Pass 52bx (region 0x80040000): rank-78 substantive from refreshed 1-150B cold-triage
// Links pre-allocated 0xfc-byte records into singly-linked free list by config count.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52bxRegion80040000Fun8004e1c4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e1c4L, "link_0xfc_record_pool_into_free_list_by_config_count" },
    };
