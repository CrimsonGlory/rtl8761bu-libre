// Pass 52cg: show ranks 86-93 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52cg extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 85; i < Math.min(94, allSmall.size()); i++) {
