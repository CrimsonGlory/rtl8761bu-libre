// Pass 52ge (region 0x80040000): BOS subindex→connection-index resolver (public BD_ADDR path).
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52geRegion80040000Fun80043774 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80043774L, "resolve_bos_connection_index_for_subindex_when_bdaddr_public" },
    };
