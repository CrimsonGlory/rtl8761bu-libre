// Pass 52hi (region 0x80040000): conn-slot-10 bit2-gated u16 range-check store → Command Complete.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hiRegion80040000Fun80044f28 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80044f28L, "hci_conn10_0x154_bit2_u16_range_check_store_0x16_send_cmd_complete" },
    };
