// Pass 52hv (region 0x80040000): transfer conn negotiation +0x14 slot, LIFO-return old.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hvRegion80040000Fun8004e858 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e858L, "transfer_conn_negotiation_slot_free_old_lifo_push" },
    };
