// Pass 52gv (region 0x80040000): sweep conn-record table releasing cleared pkt_modes.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gvRegion80040000Fun8004fd30 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004fd30L, "sweep_conn_record_table_releasing_cleared_pkt_modes" },
    };
