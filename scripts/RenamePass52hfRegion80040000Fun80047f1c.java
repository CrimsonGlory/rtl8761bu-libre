// Pass 52hf (region 0x80040000): HCI eSCO/SCO config PDU set → Command Complete sender.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hfRegion80040000Fun80047f1c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80047f1cL, "hci_esco_sco_config_pdu_set_validate_and_send_cmd_complete" },
    };
