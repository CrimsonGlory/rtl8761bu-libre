// Pass 52aw (region 0x80040000): rank-41 substantive from refreshed 1-150B cold-triage
// Purges LE channel-selection pending list nodes matching conn index byte.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52awRegion80040000Fun8004f9d8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004f9d8L, "purge_le_chan_sel_pending_list_by_conn_index_byte" },
    };
