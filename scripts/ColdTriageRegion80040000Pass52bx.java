// Pass 52bx: show ranks 78-87 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bx extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 77; i < Math.min(88, allSmall.size()); i++) {
