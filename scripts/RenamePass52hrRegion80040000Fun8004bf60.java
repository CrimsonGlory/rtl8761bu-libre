// Pass 52hr (region 0x80040000): thin wrapper → esco_sco_lmp_pdu_validate_negotiate_and_dispatch(min_hdr=6, default=1).
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hrRegion80040000Fun8004bf60 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004bf60L, "invoke_esco_sco_lmp_pdu_validate_negotiate_dispatch_min_hdr_6_default_1" },
    };
