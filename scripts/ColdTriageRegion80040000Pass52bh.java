// Pass 52bh: show ranks 51-56 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bh extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 50; i < Math.min(56, allSmall.size()); i++) {
