// Pass 52cv (region 0x80040000): >150B rank-15 bitmasked timing subfield sync
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52cvRegion80040000Fun8004f730 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004f730L, "sync_bitmasked_timing_subfields_from_active_conn_buffer" },
    };
