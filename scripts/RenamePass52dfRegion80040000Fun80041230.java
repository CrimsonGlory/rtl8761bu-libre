// Pass 52df (region 0x80040000): >150B rank-25 conn-event ring dequeue dispatcher
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52dfRegion80040000Fun80041230 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80041230L, "dequeue_conn_event_ring_and_dispatch_lmp_by_conn_type_nibble" },
    };
