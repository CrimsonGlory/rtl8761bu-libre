// Pass 52ie (region 0x80040000): deferred rank-16 mis-bound overlap with 0x8004a464
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ieRegion80040000Fun8004a444 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004a444L, "misbound_overlap_hci_copy_conn_struct_1c_6byte_send_cmd_complete" },
    };
