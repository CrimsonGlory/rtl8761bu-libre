// Pass 52cw (region 0x80040000): >150B rank-16 conn subsystem global reset
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52cwRegion80040000Fun800442bc extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800442bcL, "reset_conn_subsystem_global_state_and_reinit_slot_entries" },
    };
