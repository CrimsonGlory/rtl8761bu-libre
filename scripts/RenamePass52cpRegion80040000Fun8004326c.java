// Pass 52cp (region 0x80040000): >150B rank-9 conn-table eSCO packet-type sweep
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52cpRegion80040000Fun8004326c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004326cL, "sweep_conn_table_program_esco_packet_type_and_clear_gate_bytes" },
    };
