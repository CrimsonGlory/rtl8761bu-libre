// Pass 52es (region 0x80040000): >150B rank-4 list-B quota-overflow walk rename
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52esRegion80040000Fun8004b1d0 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004b1d0L, "walk_conn_list_b_slot_chain_collect_quota_overflow_records" },
    };
