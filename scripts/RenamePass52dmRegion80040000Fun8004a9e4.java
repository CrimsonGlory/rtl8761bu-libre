// Pass 52dm (region 0x80040000): >150B rank-32 TX segment advance clamp helper
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52dmRegion80040000Fun8004a9e4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004a9e4L, "compute_length_prefixed_segment_advance_clamped_to_remainder" },
    };
