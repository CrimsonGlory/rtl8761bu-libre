// Pass 52gu (region 0x80040000): probe linked slot list for clock-in-window.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52guRegion80040000Fun8004fa24 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004fa24L, "probe_linked_slot_list_clock_in_window" },
    };
