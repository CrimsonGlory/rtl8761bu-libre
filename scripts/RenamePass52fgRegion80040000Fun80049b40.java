// Pass 52fg (region 0x80040000): >150B rank-6 HW-reg pool flush HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fgRegion80040000Fun80049b40 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80049b40L, "hci_hw_reg_pool_flush_gated_handler_send_cmd_complete" },
    };
