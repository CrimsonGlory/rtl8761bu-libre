// Pass 52dj (region 0x80040000): >150B rank-29 HCI Create Connection page-train BB programmer
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52djRegion80040000Fun80041900 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80041900L, "program_page_train_baseband_regs_and_start_paging" },
    };
