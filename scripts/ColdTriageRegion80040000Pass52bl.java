// Pass 52bl: show ranks 59-62 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bl extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 58; i < Math.min(63, allSmall.size()); i++) {
