// Pass 52az (region 0x80040000): rank-44 substantive from refreshed 1-150B cold-triage
// LMP PDU staging slot-param ushort pair loader keyed by transaction-mode byte.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52azRegion80040000Fun80042ee0 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80042ee0L, "fill_lmp_pdu_staging_slot_params_from_txn_mode" },
    };
