// Pass 52fy (region 0x80040000): 1-150B rank-5 control-record state-byte reentry gate.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fyRegion80040000Fun80044588 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80044588L, "gate_control_record_state_byte_init_or_match" },
    };
