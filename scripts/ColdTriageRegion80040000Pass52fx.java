// Pass 52fx: refresh 1-150B ranks 1-7 for cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52fx extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 0; i < Math.min(7, allSmall.size()); i++) {
