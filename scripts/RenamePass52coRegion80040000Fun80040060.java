// Pass 52co (region 0x80040000): >150B rank-8 LMP-25C scheduling-readiness probe
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52coRegion80040000Fun80040060 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80040060L, "probe_lmp_25c_scheduling_readiness_by_credit_window" },
    };
