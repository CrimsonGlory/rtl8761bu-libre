// Pass 52bt (region 0x80040000): rank-74 substantive from refreshed 1-150B cold-triage
// HCI Command Complete sender: 6-byte conn-struct +0x1c staging + HW reg write.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52btRegion80040000Fun8004a464 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004a464L, "hci_copy_conn_struct_1c_6byte_hw_regs_field_0x165_send_cmd_complete" },
    };
