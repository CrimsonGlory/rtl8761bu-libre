// Pass 52dy (region 0x80040000): >150B rank-38 conn TX single-chunk segment walker
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52dyRegion80040000Fun8004c4a8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004c4a8L, "walk_conn_tx_single_chunk_segments_dispatch_payload_by_type" },
    };
