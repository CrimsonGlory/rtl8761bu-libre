// Pass 52hy (region 0x80040000): RSSI IIR blend coefficient constant-return stub.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hyRegion80040000Fun80042b34 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80042b34L, "return_rssi_iir_blend_coefficient_4" },
    };
