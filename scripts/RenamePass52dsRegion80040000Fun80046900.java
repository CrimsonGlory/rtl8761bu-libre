// Pass 52ds (region 0x80040000): >150B rank-32 HCI SCO packet-type table validator+stager
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52dsRegion80040000Fun80046900 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80046900L, "validate_and_stage_sco_packet_type_table_from_hci_params" },
    };
