// Pass 52bm (region 0x80040000): rank-67 substantive from refreshed 1-150B cold-triage
// HCI command handler: validate conn, copy 26-byte sync params to +0xac, alloc_tag3 dispatch.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52bmRegion80040000Fun80049420 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80049420L, "validate_conn_copy_sync_params_and_alloc_tag3_dispatch" },
    };
