// Pass 52bj: show ranks 53-58 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bj extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 52; i < Math.min(58, allSmall.size()); i++) {
