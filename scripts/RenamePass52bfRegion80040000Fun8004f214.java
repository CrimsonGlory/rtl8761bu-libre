// Pass 52bf (region 0x80040000): rank-50 substantive from refreshed 1-150B cold-triage
// One-shot armed callback dispatch before unknown_fptr_index0 case 0xb pending-bit fan-out.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52bfRegion80040000Fun8004f214 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004f214L, "invoke_armed_one_shot_callback_if_byte_0x20_set" },
    };
