// Pass 52bk: show rank 55 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bk extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 54; i < Math.min(56, allSmall.size()); i++) {
