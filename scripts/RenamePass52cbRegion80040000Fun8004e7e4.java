// Pass 52cb (region 0x80040000): rank-82 substantive from refreshed 1-150B cold-triage
// Conn-record free-list LIFO pop with state-byte write and partial clear.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52cbRegion80040000Fun8004e7e4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e7e4L, "free_list_lifo_pop_conn_record_set_state_and_clear_if_zero" },
    };
