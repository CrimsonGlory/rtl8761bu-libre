// Pass 52cb: show ranks 81-87 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52cb extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 80; i < Math.min(88, allSmall.size()); i++) {
