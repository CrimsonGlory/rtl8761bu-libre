// Pass 52ha: list top remaining 1-150B unnamed (relaxed: size>=20B)
// @category Analysis
...
public class ColdTriageRegion80040000Pass52ha extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 0; i < Math.min(8, allSmall.size()); i++) {
