// Pass 52cd: show ranks 84-90 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52cd extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 83; i < Math.min(91, allSmall.size()); i++) {
