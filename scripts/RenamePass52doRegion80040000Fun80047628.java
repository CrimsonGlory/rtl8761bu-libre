// Pass 52do (region 0x80040000): >150B rank-30 LMP PDU fragment reassembly (role-bit-set)
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52doRegion80040000Fun80047628 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80047628L, "reassemble_lmp_pdu_fragments_into_subrecord_chain_with_role_bit_set" },
    };
