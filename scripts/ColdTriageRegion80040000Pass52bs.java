// Pass 52bs: show ranks 71-78 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bs extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 70; i < Math.min(79, allSmall.size()); i++) {
