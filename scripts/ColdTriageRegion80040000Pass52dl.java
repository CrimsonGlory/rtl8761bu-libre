// Pass 52dl: list >150B ranks 25-35 for cold-triage continuation
// @category Analysis
...
public class ColdTriageRegion80040000Pass52dl extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 24; i < Math.min(35, big.size()); i++) {
            long[] c = big.get(i);
