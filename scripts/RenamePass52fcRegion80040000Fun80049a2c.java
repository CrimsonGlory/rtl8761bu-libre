// Pass 52fc (region 0x80040000): >150B rank-2 HW-reg pool entry add HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fcRegion80040000Fun80049a2c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80049a2cL, "hci_hw_reg_pool_entry_add_gated_handler_send_cmd_complete" },
    };
