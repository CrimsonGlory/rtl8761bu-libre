// Pass 52by: show ranks 79-88 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52by extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 78; i < Math.min(89, allSmall.size()); i++) {
