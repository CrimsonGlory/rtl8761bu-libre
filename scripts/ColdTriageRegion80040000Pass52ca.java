// Pass 52ca: show ranks 80-85 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52ca extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 79; i < Math.min(86, allSmall.size()); i++) {
