// Pass 52ev (region 0x80040000): >150B rank-1 LE adv data HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52evRegion80040000Fun80045c70 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80045c70L, "hci_le_adv_data_pack_validate_commit_slot10_dispatch_meta_subevent_send_cmd_complete" },
    };
