// Pass 52ar: show ranks 35-40 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52ar extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 34; i < Math.min(40, allSmall.size()); i++) {
