// Pass 52aq (region 0x80040000): rank-35 substantive from refreshed 1-150B cold-triage
// (ranks 1-34 skipped as artifacts or already done).
// Reset 4-connection LAP entries and dual-slot 0x84-stride role records.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52aqRegion80040000Fun80043bfc extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80043bfcL, "reset_four_conn_lap_and_dual_slot_role_records" },
    };
