// Pass 52ex (region 0x80040000): >150B rank-1 LE adv/scan enable HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52exRegion80040000Fun80046e40 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80046e40L, "hci_le_adv_scan_enable_feature_gate_commit_flush_send_cmd_complete" },
    };
