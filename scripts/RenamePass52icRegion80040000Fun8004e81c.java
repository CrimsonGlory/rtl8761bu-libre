// Pass 52ic (region 0x80040000): conn-record pool cluster noop return stub.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52icRegion80040000Fun8004e81c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e81cL, "noop_return_stub_conn_record_pool" },
    };
