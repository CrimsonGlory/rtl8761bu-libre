// Pass 52ee (region 0x80040000): >150B rank-2 HCI sync-conn param commit rename
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52eeRegion80040000Fun80047980 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80047980L, "validate_unique_handles_and_commit_sync_conn_params" },
    };
