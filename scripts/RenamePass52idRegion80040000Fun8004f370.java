// Pass 52id (region 0x80040000): event-queue cluster noop return stub.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52idRegion80040000Fun8004f370 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004f370L, "noop_return_stub_event_queue_cluster" },
    };
