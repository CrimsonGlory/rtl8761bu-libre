// Pass 52bo (region 0x80040000): rank-69 substantive from refreshed 1-150B cold-triage
// HCI command handler: status from field_0x165, echo cmd word, 12-byte Command Complete.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52boRegion80040000Fun800457cc extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800457ccL, "hci_global_field_0x165_status_echo_send_cmd_complete" },
    };
