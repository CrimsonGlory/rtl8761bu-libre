// Pass 52ha (region 0x80040000): inquiry pending-notify flag clear + buffer wrap.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52haRegion80040000Fun800408a4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800408a4L, "clear_inquiry_pending_notify_flag_and_wrap_buffer" },
    };
