// Pass 52ez (region 0x80040000): >150B rank-1 LE ext-adv data HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ezRegion80040000Fun80046798 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80046798L, "hci_le_ext_adv_data_pack_validate_commit_apply_vsc_0xfc97_send_cmd_complete" },
    };
