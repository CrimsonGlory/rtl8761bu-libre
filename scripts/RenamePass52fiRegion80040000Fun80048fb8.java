// Pass 52fi (region 0x80040000): >150B rank-1 link-slot alloc/commit HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fiRegion80040000Fun80048fb8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048fb8L, "hci_link_slot_alloc_and_commit_gated_handler_send_cmd_complete" },
    };
