// Pass 52be: show ranks 48-53 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52be extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 47; i < Math.min(53, allSmall.size()); i++) {
