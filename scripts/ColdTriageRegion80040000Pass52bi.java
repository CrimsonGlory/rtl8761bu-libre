// Pass 52bi: show ranks 52-57 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bi extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 51; i < Math.min(57, allSmall.size()); i++) {
