// Pass 52gh (region 0x80040000): bos[0xA] link-policy offset+dword commit HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ghRegion80040000Fun800458dc extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800458dcL, "hci_link_policy_bos0a_offset_dword_commit_send_cmd_complete" },
    };
