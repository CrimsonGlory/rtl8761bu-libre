// Pass 52gj (region 0x80040000): conn slot timing drift → HW-channel reconcile.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gjRegion80040000Fun80043388 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80043388L, "reconcile_conn_slot_timing_drift_commit_hw_channel_reconcile" },
    };
