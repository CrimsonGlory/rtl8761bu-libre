// Pass 52fn (region 0x80040000): >150B rank-1 HCI sync-conn param dispatch wrapper.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fnRegion80040000Fun80047b10 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80047b10L, "hci_sync_conn_param_commit_or_le_channel_scan_send_cmd_complete" },
    };
