// Pass 52ia (region 0x80040000): credit-scheduler context byte writer at +0x21.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52iaRegion80040000Fun8004f24c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004f24cL, "store_byte_at_credit_scheduler_global_context_offset_0x21" },
    };
