// Pass 52az: show ranks 44-48 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52az extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 43; i < Math.min(48, allSmall.size()); i++) {
