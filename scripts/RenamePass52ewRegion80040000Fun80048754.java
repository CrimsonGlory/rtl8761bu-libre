// Pass 52ew (region 0x80040000): >150B rank-1 LE adv data HCI handler (baseband-setup variant).
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ewRegion80040000Fun80048754 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048754L, "hci_le_adv_data_pack_validate_commit_slot10_program_baseband_setup_send_cmd_complete" },
    };
