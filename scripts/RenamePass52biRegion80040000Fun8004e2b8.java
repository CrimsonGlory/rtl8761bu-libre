// Pass 52bi (region 0x80040000): rank-53 substantive from refreshed 1-150B cold-triage
// Deregister conn_rec handle from sorted index table (inverse of set_link_record_index_and_register_in_table).
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52biRegion80040000Fun8004e2b8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e2b8L, "deregister_link_record_handle_from_index_table" },
    };
