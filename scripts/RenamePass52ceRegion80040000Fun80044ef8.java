// Pass 52ce (region 0x80040000): rank-85 substantive from refreshed 1-150B cold-triage
// Thin adapter: unpacks 6-byte param buffer and calls send_evt_Meta_subevent_0_or_1.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ceRegion80040000Fun80044ef8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80044ef8L, "invoke_send_evt_meta_subevent_0_or_1_from_param_buffer" },
    };
