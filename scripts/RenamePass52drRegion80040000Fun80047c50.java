// Pass 52dr (region 0x80040000): >150B rank-31 eSCO/SCO config PDU validator+committer
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52drRegion80040000Fun80047c50 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80047c50L, "parse_validate_and_commit_esco_sco_config_pdu_to_conn_record" },
    };
