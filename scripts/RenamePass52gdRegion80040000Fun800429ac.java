// Pass 52gd (region 0x80040000): 1-150B rank-8 substantive noirq OR-merge HW-channel dispatch.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gdRegion80040000Fun800429ac extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800429acL, "or_merge_hw_channel_table_entry_indexed_dispatch_noirq" },
    };
