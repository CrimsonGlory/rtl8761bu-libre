// Pass 52hs (region 0x80040000): flag-gated DLL unlink on timer/event-queue list head.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hsRegion80040000Fun8004ed90 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004ed90L, "unlink_event_list_node_by_link_status_bits" },
    };
