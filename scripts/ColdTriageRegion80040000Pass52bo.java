// Pass 52bo: show ranks 69-74 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bo extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 68; i < Math.min(75, allSmall.size()); i++) {
