// Pass 52bc (region 0x80040000): rank-47 substantive from refreshed 1-150B cold-triage
// Config-gated teardown fptr-hook triplet (hook-only slice of release_all_conn_records tail).
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52bcRegion80040000Fun8004a4bc extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004a4bcL, "invoke_teardown_hook_triplet_with_lmp_power_gate" },
    };
