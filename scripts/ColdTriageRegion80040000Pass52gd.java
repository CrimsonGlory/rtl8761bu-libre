// Pass 52gd: refresh 1-150B ranks 10-12 for cold-triage continuation
// @category Analysis
...
public class ColdTriageRegion80040000Pass52gd extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 9; i < Math.min(13, allSmall.size()); i++) {
