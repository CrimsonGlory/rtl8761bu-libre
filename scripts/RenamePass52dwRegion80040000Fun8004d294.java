// Pass 52dw (region 0x80040000): >150B rank-36 SCO/eSCO HW init blob
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52dwRegion80040000Fun8004d294 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004d294L, "init_or_reset_sco_esco_hw_registers_and_link_slots" },
    };
