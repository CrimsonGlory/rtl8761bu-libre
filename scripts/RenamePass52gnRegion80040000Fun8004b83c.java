// Pass 52gn (region 0x80040000): IRQ-guarded append to conn-slot-10 0x1ac linked list.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gnRegion80040000Fun8004b83c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004b83cL, "irq_guarded_append_to_conn_slot10_0x1ac_linked_list" },
    };
