// Pass 52dm: list >150B ranks 30-40 for cold-triage continuation
// @category Analysis
...
public class ColdTriageRegion80040000Pass52dm extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 29; i < Math.min(40, big.size()); i++) {
            long[] c = big.get(i);
