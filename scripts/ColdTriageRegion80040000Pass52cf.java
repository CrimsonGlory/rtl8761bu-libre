// Pass 52cf: show ranks 85-92 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52cf extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 84; i < Math.min(93, allSmall.size()); i++) {
