// Pass 52au: show ranks 38-43 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52au extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 37; i < Math.min(43, allSmall.size()); i++) {
