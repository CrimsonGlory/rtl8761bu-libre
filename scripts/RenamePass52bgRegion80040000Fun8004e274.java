// Pass 52bg (region 0x80040000): rank-51 substantive from refreshed 1-150B cold-triage
// Payload subrecord dual-list prepend when reassembly completes.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52bgRegion80040000Fun8004e274 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e274L, "prepend_payload_subrecord_to_pending_lists_if_low3bits_set" },
    };
