// Pass 52aq: show ranks 34-39 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52aq extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 33; i < Math.min(39, allSmall.size()); i++) {
