// Pass 52hc (region 0x80040000): inquiry lifecycle fptr 0x81 dispatch + notify clear.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hcRegion80040000Fun800408cc extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800408ccL, "dispatch_inquiry_lifecycle_fptr_0x81_and_clear_notify_flag" },
    };
