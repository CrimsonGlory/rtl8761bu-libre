// Pass 52gx (region 0x80040000): reset dual-slot role record by conn index.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gxRegion80040000Fun80043004 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80043004L, "reset_dual_slot_role_record_by_conn_index" },
    };
