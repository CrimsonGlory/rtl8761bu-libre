// Pass 52ap (region 0x80040000): rank-34 substantive from refreshed 1-150B cold-triage
// (ranks 1-33 skipped as artifacts or already done).
// SCO slot timing offset delta from HW clock phase modulo slot period.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52apRegion80040000Fun80043438 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80043438L, "compute_sco_slot_offset_delta_from_hw_clock" },
    };
