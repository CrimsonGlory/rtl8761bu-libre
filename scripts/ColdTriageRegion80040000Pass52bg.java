// Pass 52bg: show ranks 50-55 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bg extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 49; i < Math.min(55, allSmall.size()); i++) {
