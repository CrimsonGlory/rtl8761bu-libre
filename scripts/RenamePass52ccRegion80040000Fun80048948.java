// Pass 52cc (region 0x80040000): rank-83 substantive from refreshed 1-150B cold-triage
// Thin wrapper: unpacks 7-byte param buffer and calls baseband link setup handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ccRegion80040000Fun80048948 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048948L, "invoke_baseband_link_setup_from_param_buffer" },
    };
