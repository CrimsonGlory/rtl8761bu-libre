// Pass 52bl: show ranks 64-70 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bl2 extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 63; i < Math.min(71, allSmall.size()); i++) {
