// Pass 52ff (region 0x80040000): >150B rank-5 AFH poll read link RX timing HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ffRegion80040000Fun80048d6c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048d6cL, "hci_afh_poll_read_link_rx_timing_triple_send_cmd_complete" },
    };
