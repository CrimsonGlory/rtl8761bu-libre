// Pass 52gq (region 0x80040000): dual global conn-record diagnostic log wrapper.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gqRegion80040000Fun8004f6d4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004f6d4L, "log_dual_global_conn_record_mode_and_handle_diagnostic" },
    };
