// Pass 52dv (region 0x80040000): >150B rank-35 HCI scan-activity validator
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52dvRegion80040000Fun80045964 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80045964L, "validate_and_commit_hci_scan_activity_params_from_command" },
    };
