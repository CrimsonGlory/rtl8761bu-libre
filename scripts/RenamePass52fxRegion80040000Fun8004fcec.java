// Pass 52fx (region 0x80040000): 1-150B rank-6 conn-record release to free pool.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fxRegion80040000Fun8004fcec extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004fcecL, "release_conn_record_to_free_pool" },
    };
