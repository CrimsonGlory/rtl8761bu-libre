// Pass 52hb (region 0x80040000): baseband link-setup buffer adapter (packet mode 1).
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hbRegion80040000Fun80048964 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048964L, "invoke_baseband_link_setup_packet_mode1_from_param_buffer" },
    };
