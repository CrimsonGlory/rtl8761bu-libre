// Pass 52cf (region 0x80040000): rank-86 substantive from refreshed 1-150B cold-triage
// Thin adapter: stores param-buffer slot ptr to global+0x10 or ctx+4, backrefs ctx.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52cfRegion80040000Fun8004e39c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e39cL, "store_param_buffer_slot_ptr_with_context_backref" },
    };
