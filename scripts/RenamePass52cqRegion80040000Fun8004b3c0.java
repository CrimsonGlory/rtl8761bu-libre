// Pass 52cq (region 0x80040000): >150B rank-10 IRQ-locked overflow-record list splice
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52cqRegion80040000Fun8004b3c0 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004b3c0L, "splice_overflow_record_into_conn_list_a_or_b" },
    };
