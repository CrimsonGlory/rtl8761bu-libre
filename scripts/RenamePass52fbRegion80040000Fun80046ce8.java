// Pass 52fb (region 0x80040000): >150B rank-1 LE periodic adv interval HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fbRegion80040000Fun80046ce8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80046ce8L, "hci_le_periodic_adv_interval_params_validate_commit_send_cmd_complete" },
    };
