// Pass 52cx (region 0x80040000): >150B rank-17 compact link-timing baseband writer
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52cxRegion80040000Fun8004ea2c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004ea2cL, "write_compact_link_setup_timing_to_baseband_hw_regs" },
    };
