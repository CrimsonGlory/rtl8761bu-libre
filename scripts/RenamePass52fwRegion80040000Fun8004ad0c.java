// Pass 52fw (region 0x80040000): 1-150B rank-5 LMP 0x26f conn-slot word logger.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fwRegion80040000Fun8004ad0c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004ad0cL, "pack_and_log_conn_slot_word_0x26f" },
    };
