// Pass 52dn (region 0x80040000): >150B rank-30 conn-event update with RSSI/deferral
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52dnRegion80040000Fun800407e8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800407e8L, "update_conn_record_from_incoming_event_with_rssi_and_flag4_deferral" },
    };
