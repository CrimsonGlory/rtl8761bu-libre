// Pass 52bz (region 0x80040000): rank-80 substantive from refreshed 1-150B cold-triage
// HCI hw-reg pool entry remove handler with Command Complete.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52bzRegion80040000Fun8004993c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004993cL, "hci_hw_reg_pool_entry_remove_handler_send_cmd_complete" },
    };
