// Pass 52fj (region 0x80040000): >150B rank-1 eSCO packet-type broadcast HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fjRegion80040000Fun80047fb4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80047fb4L, "hci_esco_packet_type_broadcast_validate_and_commit_send_cmd_complete" },
    };
