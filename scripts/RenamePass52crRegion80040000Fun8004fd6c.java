// Pass 52cr (region 0x80040000): >150B rank-11 channel-slot enable/refcount setter
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52crRegion80040000Fun8004fd6c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004fd6cL, "set_channel_slot_enable_refcount_and_conn_record_mode" },
    };
