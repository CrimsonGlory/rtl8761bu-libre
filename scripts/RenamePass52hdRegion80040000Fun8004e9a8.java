// Pass 52hd (region 0x80040000): active-link mask bit → conn-slot index lookup (caller entry).
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hdRegion80040000Fun8004e9a8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e9a8L, "lookup_active_link_conn_slot_index_by_mask_bit" },
    };
