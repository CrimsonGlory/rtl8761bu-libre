// Pass 52at: show ranks 37-42 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52at extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 36; i < Math.min(42, allSmall.size()); i++) {
