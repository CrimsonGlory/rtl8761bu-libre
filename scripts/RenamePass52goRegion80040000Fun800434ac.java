// Pass 52go (region 0x80040000): public-BD_ADDR role-change commit + HCI evt sync.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52goRegion80040000Fun800434ac extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800434acL, "apply_public_bdaddr_role_change_commit_hci_evt_sync" },
    };
