// Pass 52an: show ranks 31-35 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52an extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 30; i < Math.min(35, allSmall.size()); i++) {
