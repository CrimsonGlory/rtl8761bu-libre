// Pass 52bk (region 0x80040000): rank-58 substantive from refreshed 1-150B cold-triage
// Active-link slot status byte lookup table (indices 2-4 -> table[0..2]).
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52bkRegion80040000Fun8004e9a4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004e9a4L, "lookup_active_link_slot_status_by_index" },
    };
