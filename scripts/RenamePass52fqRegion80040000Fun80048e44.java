// Pass 52fq (region 0x80040000): >150B rank-1 bitmap-pool flush HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fqRegion80040000Fun80048e44 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048e44L, "hci_bitmap_pool_flush_gated_handler_send_cmd_complete" },
    };
