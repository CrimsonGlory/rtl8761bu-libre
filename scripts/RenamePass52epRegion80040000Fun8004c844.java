// Pass 52ep (region 0x80040000): >150B rank-1 LC TX conn-event gate+enqueue rename
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52epRegion80040000Fun8004c844 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004c844L, "gate_lc_tx_conn_event_types_0_1_enqueue_or_emit_lmp_fallback" },
    };
