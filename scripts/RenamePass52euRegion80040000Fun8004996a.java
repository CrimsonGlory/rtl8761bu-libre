// Pass 52eu (region 0x80040000): >150B rank-6 HW-reg pool entry remove HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52euRegion80040000Fun8004996a extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004996aL, "hci_hw_reg_pool_entry_remove_gated_handler_send_cmd_complete" },
    };
