// Pass 52ho (region 0x80040000): field_0x165 status + cmd echo + two global bytes, 6-byte Command Complete.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hoRegion80040000Fun80044b3c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80044b3cL, "hci_field_0x165_cmd_echo_two_global_bytes_send_cmd_complete" },
    };
