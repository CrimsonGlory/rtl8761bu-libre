// Pass 52di (region 0x80040000): >150B rank-28 dual-slot LMP role connection accept + BB programmer
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52diRegion80040000Fun80040e60 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80040e60L, "accept_dual_slot_lmp_role_connection_and_program_baseband_regs" },
    };
