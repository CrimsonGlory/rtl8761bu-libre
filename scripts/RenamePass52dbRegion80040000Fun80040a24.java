// Pass 52db (region 0x80040000): >150B rank-21 dual-slot LMP-25C role-record packet processor
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52dbRegion80040000Fun80040a24 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80040a24L, "process_dual_slot_lmp25c_role_record_packet_completion" },
    };
