// Pass 52ax: show ranks 41-46 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52ax extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 40; i < Math.min(46, allSmall.size()); i++) {
