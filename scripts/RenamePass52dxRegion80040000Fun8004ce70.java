// Pass 52dx (region 0x80040000): >150B rank-37 conn TX packet-type dispatcher
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52dxRegion80040000Fun8004ce70 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004ce70L, "dispatch_conn_tx_by_packet_type_nibble_with_reassembly" },
    };
