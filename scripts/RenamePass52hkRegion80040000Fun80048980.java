// Pass 52hk (region 0x80040000): HCI cmd-status OK + 8-byte param staging + conn-state log 0x26f.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hkRegion80040000Fun80048980 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048980L, "hci_stage_8byte_param_log_0x26f_send_cmd_status" },
    };
