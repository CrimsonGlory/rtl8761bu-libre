// Pass 52ap: show ranks 33-37 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52ap extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 32; i < Math.min(37, allSmall.size()); i++) {
