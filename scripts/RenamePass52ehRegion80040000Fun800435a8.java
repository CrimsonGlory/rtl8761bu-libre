// Pass 52eh (region 0x80040000): >150B rank-3 inquiry LAP slot reassignment rename
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ehRegion80040000Fun800435a8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800435a8L, "reassign_inquiry_lap_slot_refcount_pending_and_program_channel" },
    };
