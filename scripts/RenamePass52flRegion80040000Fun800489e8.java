// Pass 52fl (region 0x80040000): >150B rank-1 AFH-gated link-slot flag bitmap commit HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52flRegion80040000Fun800489e8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800489e8L, "hci_afh_gated_link_slot_flag_bitmap_commit_send_cmd_complete" },
    };
