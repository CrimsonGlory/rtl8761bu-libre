// Pass 52eb (region 0x80040000): >150B rank-1 TX segment dispatcher rename
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ebRegion80040000Fun8004ae74 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004ae74L, "walk_conn_tx_segments_dispatch_by_packet_type_nibble" },
    };
