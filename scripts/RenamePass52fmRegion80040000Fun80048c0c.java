// Pass 52fm (region 0x80040000): >150B rank-1 AFH-gated conn10 HW-ctrl + LMP recovery HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fmRegion80040000Fun80048c0c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048c0cL, "hci_afh_gated_conn10_hw_ctrl_and_lmp_recovery_send_cmd_complete" },
    };
