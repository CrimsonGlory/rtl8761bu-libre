// Pass 52gl (region 0x80040000): PDU slot budget validator + HW write hook dispatch.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52glRegion80040000Fun8004f824 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004f824L, "validate_pdu_slot_budget_and_dispatch_hw_write_hook" },
    };
