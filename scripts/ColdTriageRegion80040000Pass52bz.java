// Pass 52bz: show ranks 80-89 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bz extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 79; i < Math.min(90, allSmall.size()); i++) {
