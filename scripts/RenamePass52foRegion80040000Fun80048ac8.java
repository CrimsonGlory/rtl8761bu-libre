// Pass 52fo (region 0x80040000): >150B rank-1 AFH-gated link-reg 0x2e timing triple HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52foRegion80040000Fun80048ac8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048ac8L, "hci_afh_gated_read_link_reg_0x2e_timing_triple_send_cmd_complete" },
    };
