// Pass 52hp (region 0x80040000): field_0x165 status + cmd echo + eight global bytes, 12-byte Command Complete.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hpRegion80040000Fun80045bb4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80045bb4L, "hci_field_0x165_cmd_echo_eight_global_bytes_send_cmd_complete" },
    };
