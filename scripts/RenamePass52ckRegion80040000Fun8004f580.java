// Pass 52ck (region 0x80040000): >150B rank-3 dual-list sorted event insert
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52ckRegion80040000Fun8004f580 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004f580L, "dual_list_sorted_event_insert_with_overlap_pushback" },
    };
