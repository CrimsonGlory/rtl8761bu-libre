// Pass 52cz (region 0x80040000): >150B rank-19 pending-negotiation hash pop
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52czRegion80040000Fun8004f25c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004f25cL, "pending_negotiation_hash_pop_by_distance" },
    };
