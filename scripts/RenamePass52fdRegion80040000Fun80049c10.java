// Pass 52fd (region 0x80040000): >150B rank-3 HW-reg pool commit HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fdRegion80040000Fun80049c10 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80049c10L, "hci_hw_reg_pool_commit_gated_handler_send_cmd_complete_and_le_conn_complete" },
    };
