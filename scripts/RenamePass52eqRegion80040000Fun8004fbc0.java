// Pass 52eq (region 0x80040000): >150B rank-2 conn-slot timing re-arm rename
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52eqRegion80040000Fun8004fbc0 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004fbc0L, "rearm_conn_slot_timing_instant_to_target_and_walk_linked_windows" },
    };
