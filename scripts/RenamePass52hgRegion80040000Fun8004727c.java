// Pass 52hg (region 0x80040000): HCI conn release by handle → Command Complete sender.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hgRegion80040000Fun8004727c extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004727cL, "hci_release_conn_by_handle_validate_and_send_cmd_complete" },
    };
