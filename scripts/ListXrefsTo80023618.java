...
public class ListXrefsTo80023618 extends GhidraScript {
    @Override
    public void run() throws Exception {
        Address addr = toAddr(0x80023618L);
        Function fn = getFunctionAt(addr);
        if (fn == null) {
            println("ERROR: no function at 0x80023618");
            return;
        }
        println("Xrefs to " + fn.getName() + " @ 0x80023618:");
