// Pass 52hj (region 0x80040000): reentry-gated field_0x165 status + global-byte 5-byte Command Complete.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hjRegion80040000Fun80044b90 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80044b90L, "hci_reentry_gate_field_0x165_global_byte_send_cmd_complete" },
    };
