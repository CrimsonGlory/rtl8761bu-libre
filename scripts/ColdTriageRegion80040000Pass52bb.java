// Pass 52bb: show ranks 46-50 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bb extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 45; i < Math.min(50, allSmall.size()); i++) {
