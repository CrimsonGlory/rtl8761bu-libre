// Pass 52ao (region 0x80040000): rank-33 substantive from refreshed 1-150B cold-triage
// (ranks 1-32 skipped as artifacts or already done).
// IRQ-masked append byte to conn list-A tail with count increment.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52aoRegion80040000Fun8004b0f8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004b0f8L, "irq_masked_append_byte_to_conn_list_a_tail" },
    };
