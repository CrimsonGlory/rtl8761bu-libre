// Pass 52cg (region 0x80040000): rank-87 substantive from refreshed 1-150B cold-triage
// Thin adapter: zeroes two u32 fields + trailing byte in param buffer.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52cgRegion80040000Fun8004a4fc extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004a4fcL, "zero_param_buffer_two_u32_and_byte" },
    };
