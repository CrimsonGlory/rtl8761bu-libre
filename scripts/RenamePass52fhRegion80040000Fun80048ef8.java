// Pass 52fh (region 0x80040000): >150B rank-7 bitmap-pool entry remove HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fhRegion80040000Fun80048ef8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80048ef8L, "hci_bitmap_pool_entry_remove_gated_handler_send_cmd_complete" },
    };
