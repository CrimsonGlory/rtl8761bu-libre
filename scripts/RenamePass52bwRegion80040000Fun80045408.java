// Pass 52bw (region 0x80040000): rank-77 substantive from refreshed 1-150B cold-triage
// HCI Command Complete sender: field_0x165 status + 7-byte template with 0xfb/8 tail.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52bwRegion80040000Fun80045408 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80045408L, "hci_global_field_0x165_status_echo_fb8_template_send_cmd_complete" },
    };
