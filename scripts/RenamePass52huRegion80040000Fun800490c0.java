// Pass 52hu (region 0x80040000): thin HCI cmd-complete success wrapper for opcode 0x202f.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52huRegion80040000Fun800490c0 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800490c0L, "invoke_ogc3_tons_cmd_complete_success_opcode_0x202f" },
    };
