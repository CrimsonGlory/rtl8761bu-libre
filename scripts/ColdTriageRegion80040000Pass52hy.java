// Pass 52hy: pivot to >150B unnamed tier (1-150B size>=20B exhausted)
// @category Analysis
...
public class ColdTriageRegion80040000Pass52hy extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 0; i < Math.min(8, big.size()); i++) {
            long[] c = big.get(i);
            String bucket = c[2] <= 300 ? "151-300B" : c[2] <= 600 ? "301-600B" : "601+B";
