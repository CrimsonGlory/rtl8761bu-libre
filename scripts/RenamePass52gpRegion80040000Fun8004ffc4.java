// Pass 52gp (region 0x80040000): conn-negotiation state pool pop + template init.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52gpRegion80040000Fun8004ffc4 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x8004ffc4L, "pop_conn_negotiation_state_node_init_from_template" },
    };
