// Pass 52ey (region 0x80040000): >150B rank-1 LE scan-params HCI handler.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52eyRegion80040000Fun800451cc extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800451ccL, "hci_le_scan_params_reentry_gate_interval_window_commit_send_cmd_complete" },
    };
