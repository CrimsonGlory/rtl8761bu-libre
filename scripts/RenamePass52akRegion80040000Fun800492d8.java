// Pass 52ak (region 0x80040000): rank-29 substantive from refreshed 1-150B cold-triage
// (ranks 1-28 skipped as artifacts or already done).
// HCI handler: copies two 16-byte blocks from cmd payload, runs hw_crypto_compute,
// packs status + 16-byte digest into Command Complete (0xe) event.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52akRegion80040000Fun800492d8 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x800492d8L, "hci_hw_crypto_dual_block_digest_handler_send_cmd_complete" },
    };
