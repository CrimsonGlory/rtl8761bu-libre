// Pass 52ht (region 0x80040000): inquiry/LAP slot pending-bit status code lookup.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52htRegion80040000Fun80042d74 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80042d74L, "get_inquiry_lap_slot_pending_status_code_by_index" },
    };
