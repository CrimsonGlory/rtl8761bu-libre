// Pass 52bu: show ranks 73-82 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52bu extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 72; i < Math.min(83, allSmall.size()); i++) {
