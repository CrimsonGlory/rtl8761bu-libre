// Pass 52hh (region 0x80040000): HCI sync-conn link-param store → Command Complete sender.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hhRegion80040000Fun80047bdc extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80047bdcL, "hci_sync_conn_link_param_store_to_record_send_cmd_complete" },
    };
