// Pass 52hq (region 0x80040000): field_0x165 status + cmd echo + const byte 0x20, 5-byte Command Complete.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52hqRegion80040000Fun80045188 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80045188L, "hci_field_0x165_cmd_echo_const_byte_0x20_send_cmd_complete" },
    };
