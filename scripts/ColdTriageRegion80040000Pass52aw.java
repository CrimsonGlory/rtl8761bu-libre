// Pass 52aw: show ranks 40-45 from refreshed 1-150B cold-triage
// @category Analysis
...
public class ColdTriageRegion80040000Pass52aw extends GhidraScript {
    public void run() throws Exception {
        ...
        for (int i = 39; i < Math.min(45, allSmall.size()); i++) {
