// Pass 52fu (region 0x80040000): 1-150B rank-4 HW-channel dual-dispatch reset.
// @category Analysis
import ghidra.app.script.GhidraScript;
import ghidra.program.model.listing.*;
import ghidra.program.model.address.*;

public class RenamePass52fuRegion80040000Fun80043038 extends GhidraScript {

    static final Object[][] RENAMES = {
        { 0x80043038L, "irq_guarded_hw_channel_dual_dispatch_slot_zero" },
    };
